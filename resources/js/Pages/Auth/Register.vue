...
const shelters = usePage().props.shelters.data;
</script>
...
<template>
    <GuestLayout>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-4">
                <InputLabel for="shelter_id" value="Shelter"/>
                ...
                >
                    ...
                    <option v-for="shelter in shelters" :value="shelter.id" v-text="shelter.name"></option>
                </select>

                <InputError class="mt-2" :message="form.errors.shelter_id"/>
            </div>
